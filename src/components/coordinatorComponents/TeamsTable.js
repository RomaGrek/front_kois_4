...
class TeamsTable extends React.Component{
    ...
    render() {
        const {page, teams_table, style} = this.props;
        return(
            <div className="form" width={ page.pageWidth} style={style.style.teams_table.genDiv}>
                <p>List of teams</p>
                <div className="result" style={style.style.result.block}>
                    ...
                    <table width="90%" id="result" style={style.style.result.block}>
                        ...
                        <tr>
                            ...
                            <th style={style.style.result.header}>Team level</th>
                            <th  style={style.style.result.header}>Status team</th>
                        </tr>
                        </thead>

                        <tbody>
                        {teams_table.map((item) => (
                            <tr
                                // key={this.state.key}
                            >
                                <td>
