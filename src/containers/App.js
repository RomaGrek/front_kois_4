...
class App extends React.Component {
  constructor(props) {
    ...
    if (size >= 1025){
        ...
        this.props.setWidth(size *0.9);        // 0.9
    ...
    return (
        <div className="App">
          <BrowserRouter>
            ...
            <Route exact={true} strict={true} path="/coordinator" component={CoordinatorPage}/>
              <Route exact={true} strict={true} path="/team" component={TeamPage}/>
              <Route exact={true} strict={true} path="/trader" component={TraderPage}/>
          </BrowserRouter>
        </div>
    );
  }
