export const styleDesktop = {
    ...
    // стили для дива эксперимента у команды
    ...
    // стили для блока с получением доступных районов для команды
    formView: {
        block:{
            backgroundImage: "linear-gradient(#FFFFFF,#d6d6d6)",
            color: 'black',
        ...
        descriptionY: {          // надписи типа выбирите X
            marginTop: "20px" ,
            fontSize: '15px',
            textAlign: 'center',
            width: '100%'
